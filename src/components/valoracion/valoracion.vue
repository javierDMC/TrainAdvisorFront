    ...
    <article class="mt-10 ml-10">
      ...
      <footer class="mb-5 text-sm text-gray-500 ">
        <p>Viajó el <time datetime="2023-04-24 19:00">24 de mayo de 2023 llegando a las </time><time
            ...
            <h3 class="mt-1 text-sm font-semibold text-gray-900">Intercity Renfe Valencia-Estacio del Nord a Barcelona-Sants</h3>
      </footer>
      ...
      <p class="mb-3 text-gray-500 ">Por el camino pasó por un taller y se quedó sin luz un rato. No lo recomiendo para
        nada.
      </p>
  ...
  <div class="border-4 border-lime-500 ml-2 mr-2 mt-2 shadow-2xl">
    <article class="mt-10 ml-10">
      <div class="flex items-center mb-4 space-x-4">
        ...
        <div class="space-y-1 font-medium">
          <p>Pepe Martínez</p>
          <p class="block text-sm text-gray-500">12 valoraciones (8 votos útiles)</p>
        </div>
      </div>
      <div class="flex items-center mb-1">
        <svg aria-hidden="true" class="w-5 h-5 text-yellow-400" fill="currentColor" viewBox="0 0 20 20"
        ...
        <h3 class="ml-2 text-m font-bold text-gray-900">Intercity cómodo y agradable</h3>
      </div>
      <footer class="mb-5 text-sm text-gray-500 ">
        <p>Viajó el <time datetime="2023-04-24 19:00">12 de octubre de 2022 llegando a las </time><time
            datetime="2023-04-24 20:45">20:05</time></p>
            <h3 class="mt-1 text-sm font-semibold text-gray-900">Intercity Renfe Valencia-Estacio del Nord a Barcelona-Sants</h3>
      </footer>
      <p class="mb-2 text-gray-500 ">Tren algo antiguo pero muy cómodo, en los que da gusto viajar.</p>
      <p class="mb-3 text-gray-500 ">Hay enchufes para conectar el movil o el portatil, pero eché en falta WI-FI
      </p>
      <a href="#" class="block mb-5 text-sm font-medium text-blue-600 hover:underline">Leer más</a>
      <aside>
        <p class="mt-1 text-xs text-gray-500 ">A 6 usuarios les ha resultado útil</p>
        <div class="flex items-center mt-3 mb-3 space-x-3 divide-x divide-gray-200">
          <a href="#"
            class="text-green-600 bg-white border border-gray-300 focus:outline-none hover:bg-gray-200 focus:ring-4 focus:ring-gray-200 font-medium rounded-lg text-xs px-2 py-1.5">Útil</a>
          <a href="#" class="pl-4 text-sm font-medium text-red-500 hover:underline">Reportar valoración</a>
